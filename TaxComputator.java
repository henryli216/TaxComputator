	 ...
	 public static void marriedcalculator(double income,double wifeincome) {
	    ...
	    public static void singlecalculator(double income) {
	     ...
	     public static void main(String[] args) {
            ...
            switch(checkVar){
            case "N":
            	System.out.println("Please input your income for the year of assessment¡G");
    	        if(income == 0){
    	        ...
    	        break;
            case "Y":
            	System.out.println("Please input you and your wife income for the year of assessment¡G");
